...
},{"superagent":28}],7:[function(_dereq_,module,exports){
'use strict';
...
},{"resolve-url":27}],9:[function(_dereq_,module,exports){
'use strict';
...
},{"minilog":4}],10:[function(_dereq_,module,exports){
'use strict';

var minilog = _dereq_('minilog')
  , checkHttpStatus = _dereq_('./transforms/check_http_status')
  , abortTraversal = _dereq_('./abort_traversal')
  , httpRequests = _dereq_('./http_requests')
  , parse = _dereq_('./transforms/parse')
...
function afterGetUrl(t, callback) {
  ...
  if (t.step.url) {
    ...
    return callback(null, t.startUrl + t.step.doc._links.self.href);
  } else {
...
},{"./abort_traversal":9,"./http_requests":12,"./transforms/check_http_status":18,"./transforms/parse":21,"./walker":25,"minilog":4}],11:[function(_dereq_,module,exports){
'use strict';
...
var actions = _dereq_('./actions')
  , abortTraversal = _dereq_('./abort_traversal').abortTraversal
...
Builder.prototype.getResource = function(callback) {
  var t = createInitialTraversalState(this);
  return actions.getResource(t, callback);
};
 ...
 * yields the last URL to the callback.
 */
Builder.prototype.getUrl = function(callback) {
  var t = createInitialTraversalState(this);
  return actions.getUrl(t, callback);
};
...
Builder.prototype.post = function(body, callback) {
  ...
  return actions.post(t, callback);
};
...
Builder.prototype.patch = function(body, callback) {
  var t = createInitialTraversalState(this, body);
  return actions.patch(t, callback);
};
...
Builder.prototype.delete = function(callback) {
  var t = createInitialTraversalState(this);
  return actions.delete(t, callback);
};
...
},{"./abort_traversal":9,"./actions":10,"./media_type_registry":14,"./media_types":15,"./merge_recursive":16,"minilog":4,"request":6,"util":5}],12:[function(_dereq_,module,exports){
'use strict';
var minilog = _dereq_('minilog')
  , log = minilog('traverson')
  , abortTraversal = _dereq_('./abort_traversal')
  , detectContentType = _dereq_('./transforms/detect_content_type')
  , getOptionsForStep = _dereq_('./transforms/get_options_for_step');
...
function executeHttpGet(t, callback) {
  ...
  log.debug('GET request to ', t.step.url);
  log.debug('options ', options);
  t.currentRequest =
    t.requestModuleInstance.get(t.step.url, options,
        function(err, response, body) {
    log.debug('HTTP request to ' + t.step.url + ' returned');
...
exports.executeHttpRequest = function(t, request, method, callback) {
  ...
  log.debug(method.name + 'request to ', t.step.url);
  log.debug('options ', requestOptions);
  t.currentRequest =
    method.call(request, t.step.url, requestOptions, function(err, response) {
    log.debug('HTTP request to ' + t.step.url + ' returned');
    t.currentRequest = null;
    if (err) {
      return callback(err, response, t.step.url);
    }
    return callback(null, response, t.step.url);
  });
  abortTraversal.registerAbortListener(t, callback);
};

},{"./abort_traversal":9,"./transforms/detect_content_type":19,"./transforms/get_options_for_step":20,"minilog":4}],13:[function(_dereq_,module,exports){
'use strict';
...
},{"JSONPath":26,"minilog":4,"underscore.string":7}],14:[function(_dereq_,module,exports){
'use strict';
...
},{"./json_adapter":13,"./media_types":15,"./negotiation_adapter":17}],15:[function(_dereq_,module,exports){
'use strict';
...
},{"minilog":4}],19:[function(_dereq_,module,exports){
'use strict';

var minilog = _dereq_('minilog')
  , log = minilog('traverson');

var mediaTypeRegistry = _dereq_('../media_type_registry');
...
},{"../media_type_registry":14,"minilog":4}],20:[function(_dereq_,module,exports){
'use strict';
...
},{"minilog":4,"util":5}],21:[function(_dereq_,module,exports){
'use strict';
...
},{"minilog":4}],22:[function(_dereq_,module,exports){
'use strict';
...
},{"minilog":4,"underscore.string":7,"url":8}],23:[function(_dereq_,module,exports){
'use strict';
...
},{"minilog":4,"underscore.string":7,"url-template":31,"util":5}],24:[function(_dereq_,module,exports){
'use strict';
...
},{"minilog":4}],25:[function(_dereq_,module,exports){
'use strict';
...
var minilog = _dereq_('minilog')
  ...
  , httpRequests = _dereq_('./http_requests')
  , parse = _dereq_('./transforms/parse')
  , resolveNextUrl = _dereq_('./transforms/resolve_next_url')
  , resolveUriTemplate = _dereq_('./transforms/resolve_uri_template')
  , switchToNextStep = _dereq_('./transforms/switch_to_next_step');
...
},{"./abort_traversal":9,"./http_requests":12,"./transforms/check_http_status":18,"./transforms/parse":21,"./transforms/resolve_next_url":22,"./transforms/resolve_uri_template":23,"./transforms/switch_to_next_step":24,"minilog":4}],26:[function(_dereq_,module,exports){
...
},{"vm":2}],27:[function(_dereq_,module,exports){
...
},{"./lib/builder":11,"./lib/media_type_registry":14,"./lib/media_types":15,"minilog":4}],33:[function(_dereq_,module,exports){
/* global angular */
'use strict';
